...
const OAUTH_CLIENT_ID = process.env.OAUTH_CLIENT_ID || 'GOOGLE_CLIENT_ID_PLACEHOLDER';

// OAuth Secret value used to initiate OAuth2Client class.
const OAUTH_CLIENT_SECRET = process.env.OAUTH_CLIENT_SECRET || 'GOOGLE_CLIENT_SECRET_PLACEHOLDER';
